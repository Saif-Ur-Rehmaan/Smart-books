                                        ...
                                        <div class="banner-static static-top-smartbooks1">
                                            ...
                                            <div class="col col2">
                                                <div class="image">
                                                    ...
                                                    <a href="pages/products.php?filter=sale&q=40%">
                                                                            ...
                                                                            <div class="item-inner">
                                                                                <div class="caption-top">
                                                                                    ...
                                                                                    <h4 class="product-name">
                                                                                        <a
                                                                                            href="pages/.php?productdetails=<?php echo urlencode(json_encode(["imagename" => $imagename, "BookTitle" => $BookTitle, "Bookid" => $Bookid, "catId" => $catId, "catName" => $catName])); //to decode this json use $productdetails = $_GET['productdetails'];then $productData = json_decode(urldecode($productdetails), true); ?>">
                                                                                            <?php echo $BookTitle ?>
                                                                                        </a>
                                                                                    </h4>
                                                                                </div>
...
RIGHT JOIN books ON categories.id = books.category_id order by views desc ";
                                                                        ...
                                                                        <div class="item-inner">
                                                                            ...
                                                                            <div class="caption">
                                                                                <div class="inner  swtch">
                                                                                    ...
                                                                                    <p class="manufacture-product">
                                                                                        <a href="pages/products.php?bookid=<?php echo $Bookid ?>"
  ...
  foreach ($price_saleprice as $key => $value) {
    ...
    $saleprice = $value["sale_price"]; ?>
        ...
        btn.on("click", () => {
            let searchtxt = encodeURI($("#text-search").value);
