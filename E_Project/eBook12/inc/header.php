                        ...
                        <li class="li-top-item">
                          ...
                          <div class="sub-menu-container">
                            <ul class="ul-second-items">
                              ...
                              <li class="li-second-items">
                                ...
                                <div class="flyout-third-items">
                                  <ul class="ul-third-items">
                                    ...
                                    <li class="li-third-items">
                                      <a href="collections/all/index.php@fts=0&amp;preview_theme_id=.php"
                                        class="a-third-link">
                                    ...
                                    <li class="li-third-items">
                                      <a href="collections/all/index.php@preview_theme_id=74461806644.php"
                                        class="a-third-link">
                                    ...
                                    <li class="li-third-items">
                                      <a href="collections/all/index.php@preview_theme_id=74460889140.php"
                                        class="a-third-link">
                              ...
                              <li class="li-second-items">
                                <a href="blogs/news.php" class="a-second-link a-item">
                                ...
                                <div class="flyout-third-items">
                                  <ul class="ul-third-items">
                                    ...
                                    <li class="li-third-items">
                                      <a href="blogs/news.php" class="a-third-link">
                              ...
                              <li class="li-second-items">
                                <a href="pages/contact-us.php" class="a-second-link a-item">
                              ...
                              <li class="li-second-items">
                                <a href="pages/faqs.php" class="a-second-link a-item">
                              ...
                              <li class="li-second-items">
                                <a href="pages/wishlist.php" class="a-second-link a-item">
                    ...
                    <div role="menu" id="oc-menu-header" class="oc-menu horizontal-menu oc-menu-bar visible-lg">
                      ...
                      <ul class="ul-top-items">
                        ...
                        <li class="li-top-item left has-child" style="float: left;">
                          ...
                          <a class="a-top-link" href="collections/all/index.php@preview_theme_id=74460266548.php">
                            <span>Catalog</span>
                            <i class="fas fa-chevron-down" aria-hidden="true"></i>
                          </a>
                          <!-- Mega Menu -->
              ...
              <div class="col-search">
                <div id="search-by-category">
                  ...
                  <div id="sp-btn-search" class="">
                    <button type="button" id="btn-search-category" onclick="window.location.href='<?php  echo (basename($_SERVER['SCRIPT_FILENAME'])=='index.php') ? '' : 'pages/'; ?>search.php?q='+document.getElementById('text-search').value" class="btn btn-default btn-lg">
                      <span>Search</span>
                    </button>
