          ...
          <div class="modal-product">
            ...
            <div class="product-images">
              <div class="main-image images">
                <img alt="" src="<?php echo (basename($_SERVER["SCRIPT_FILENAME"])=="index.php") ? "" : "../" ; ?>images/products/<?php echo DatabaseManager::select("books","image_name","id=$bookid")[0]["image_name"] ?>" class="img-responsive">
              </div>
            </div>
            <!-- end product images -->
